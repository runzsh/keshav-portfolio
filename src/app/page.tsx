		...
		<main className="flex flex-col min-h-[100dvh] space-y-10">
					...
					<div className="gap-2 flex justify-between">
						<div className="flex-col flex flex-1 space-y-1.5">
							<BlurFadeText
								...
								className="text-2xl font-bold tracking-tight sm:text-3xl xl:text-4xl"
								yOffset={8}
								text={`Hi, I'm ${DATA.name.split(" ")[0]} 👋`}
							/>
							<BlurFadeText className="max-w-[600px] text-base md:text-lg" delay={BLUR_FADE_DELAY} text={DATA.description} />
						</div>
			...
			<section id="about">
				...
				<BlurFade delay={BLUR_FADE_DELAY * 4}>
					<Markdown className="prose max-w-full text-justify font-sans text-sm text-gray-700 dark:text-gray-300 dark:prose-invert leading-relaxed">
						{DATA.summary}
					</Markdown>
				</BlurFade>
			</section>
