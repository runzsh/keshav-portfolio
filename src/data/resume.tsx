...
export const DATA = {
	name: "Keshav Yadav",
	initials: "Keshav",
	url: "https://metaltoys.xyz",
	location: "Goa, India",
	locationLink: "https://www.google.com/maps/place/goa",
	description:
		"Budding chef transitioning to automotive engineering. Applying precision and work ethic from professional kitchens to pursue cars.",
	summary:
		"A through & through car buff, from India. I have always been the go to person at home for all things hands-on! Be it, helping dad with home deeds like plumbing & electric maintenance on the weekends to opening & re-assembling all my toys & miniatures, learning about all kind of machines have always been my niche. I have invariably had a calling towards machines and cars, and the mechanism. I try to document my experiences while I work on my car, feel free to check them out under [blog](/blog).",
	avatarUrl: "/me.png",
	skills: [
		"Food Menu Engineering",
		"Culinary: Filleting, Butchery",
	...
	contact: {
		email: "keshavyadav.dcc@gmail.com",
		tel: "+91 9896920303",
		social: {
			// GitHub: {
			// 	name: "GitHub",
			// 	url: "https://dub.sh/shadow-github",
			// 	icon: Icons.github,
			...
			LinkedIn: {
				name: "LinkedIn",
				url: "https://www.linkedin.com/in/keshav-yadav-529443223",
				icon: Icons.linkedin,
			...
			email: {
				name: "Send Email",
				url: "mailto:keshavyadav.dcc@gmail.com",
				icon: Icons.email,
				navbar: true
			}
		}
	...
	work: [
		{
			company: "Praça Prazeres",
			href: "https://www.instagram.com/praca.prazeres/?hl=en",
			badges: [],
			location: "Panjim, Goa",
			title: "Cook",
			logoUrl: "/pp.png",
		...
		},
		{
			...
			badges: [],
			href: "https://www.thebombaycanteen.com/",
		...
		},
		{
			...
			badges: [],
			href: "https://www.marriott.com/en-us/hotels/bomxr-the-st-regis-mumbai/overview/",
			location: "Mumbai, India",
	...
	education: [
		{
			school: "Institute of Hotel Management Mumbai",
			href: "https://www.ihmctan.edu/",
			degree: "Bachelor of Science in Hospitality and Hotel Administration (B.Sc)",
			logoUrl: "/ihmm.png",
			start: "2021",
			end: "2024"
		},
